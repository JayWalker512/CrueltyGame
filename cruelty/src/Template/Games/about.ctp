...
<p>This is a multiplayer web game inspired by an anecdote in the book "A Mathematician Plays The Stock Market" by John Allen Paulos. He called the story "My Pedagogical Cruelty" and it goes more or less as follows.</p>
